...
//                }
                ...
                StorageService.savePhoto(username: userName, uid: authData.user.uid, data: imageSelected, metadata: metadata, storageProfileRef: storageProfile, dict: dict,onError: { (errorMessage) in
                    callback(true)
                })
